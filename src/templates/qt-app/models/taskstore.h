...
//
// QAbstractListModel is the contract a ListView binds to. You implement three
// methods -- rowCount(), data() and roleNames() -- and the view calls them as it
// paints. The view NEVER gets your Task objects; it asks "give me field X of
// row N", where X is a numeric role id that roleNames() maps to the name the
// QML delegate uses.
//
