    ...
    : QAbstractListModel(parent)
{
    ...
    addTask(QStringLiteral("Wire up the C++ model"), QStringLiteral("Alex"), Priority::High);
    addTask(QStringLiteral("Learn QAbstractListModel"), QStringLiteral("Alex"), Priority::Normal);
    addTask(QStringLiteral("Review the theme singleton"), QStringLiteral("Sam"), Priority::Normal);
    addTask(QStringLiteral("Ship the first release"), QStringLiteral("Sam"), Priority::Low);
