...
// Tab 4. The original one-object demo, moved here unchanged in spirit: a
// KoljaViewModel instance created right in the QML, with properties bound to
// labels and Q_INVOKABLE methods wired to buttons.
//
// Note the contrast with the other tabs. This object is declared HERE, so it
// belongs to this view and dies with it. TaskStore and AppTheme are singletons
// and are shared by everything.
Item {
    id: root
